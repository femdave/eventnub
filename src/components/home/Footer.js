...
import { Container, Box, Stack, Typography, styled, InputAdornment, IconButton, Divider } from '@mui/material';
...
export default function Footer() {
  ...
  return (
    <Container maxWidth="xl" sx={{ backgroundColor: '#1358A5', color: '#fff' }}>
      <Box sx={{ height: '50vh' }}>
        <Box sx={{ display: 'flex', height: '80%', width: '100%', justifyContent: 'space-between' }}>
          <Box sx={{ width: '350px' }}>
            <Stack>
              <Box sx={{ display: 'flex', alignItems: 'center', marginTop: '30px' }}>
                ...
                <Typography sx={{ color: '#FFFFFF', fontWeight: '600', letterSpacing: 5, fontSize: 200 }} variant="h5">
                  eventnub
                </Typography>
              </Box>
